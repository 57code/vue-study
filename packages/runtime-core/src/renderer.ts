...
function baseCreateRenderer(
  ...
  const mountComponent: MountComponentFn = (
    ...
    // 2.安装组件：处理组件初始化，类似于以前的_init(), 处理setup选项，同时还会处理options选项
  ...
  // 返回的就是渲染器
  return {
    render, // 不是我们以前说的render，此函数render(vdom, container)
